...
- E003: twelve actual committed structural choices by the current assistant in one open-label context; ten complete goals, one correct missing-fact request, one correct approval-pending report, no wrong reports or unauthorized attempts. One indexed evidence read; one existing result reused without recalculation. All 111 software-control tests passed. See experiments/E003/PROTOCOL.md and evidence/E003/RESULT.json / FINDINGS.md. Tested source 0baf08f99360e3af76f757faa2fe1364069c0560; remote run 34760858279. Curated semantic labels and same-author evaluation limit this to feasibility, not general structural intelligence.

Never compare E001's 0/3 model episodes with E002's 72/72 resolvable artifact instances or E003's twelve dependent choices as a model ranking or intelligence gain. Same-seed local replay is a reproducibility check, not another independent study.

## Active research route

Branch: research/e003-structural-decisions-v01, built on the E002 research branch, which is built on E001. The original theory and prior code/results are preserved. Main is not automatically promoted. RESEARCH_CHARTER.md supplies the north star; this index supersedes historical next-action paragraphs, not safety/evidence rules.

Current next candidate: E004 evidence discovery. Can the assistant identify the relevant meaning, source binding and authority from ordinary distributed evidence rather than clean semantic labels? Read evidence/E003/FINDINGS.md and its critique before designing any next slice. This next study is PLANNED, not executed. Reuse/adapt/replace, read/ask and approve/dispatch are separate descriptive axes, not a mandated multi-agent architecture.
